...
export default function AddRtoStep4({
  onNext,
  onPrev,
  onCancel,
  onSaveDraft,
    ...
    <div className="p-8 space-y-6 max-w-7xl mx-auto bg-[#F8FAFC] min-h-screen font-sans text-slate-800">
      ...
      <div className="grid grid-cols-12 gap-6 items-start">
        <div className="col-span-12 lg:col-span-8 bg-white rounded-2xl border border-slate-200 shadow-sm p-8 space-y-6">
          <div>
            <h3 className="text-base font-bold text-slate-800">Partnership Details</h3>
            <p className="text-xs text-slate-500 mt-0.5">Provide information about the partnership and registration details.</p>
          </div>
